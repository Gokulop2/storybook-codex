...
export const AVATAR_IMAGE_SHELL_BLOCK =
    "relative shrink-0 overflow-hidden outline-[0.5px] -outline-offset-[0.5px] outline-black/16 before:inset-[0.5px]";

/** Fills a padded outer frame; inner radius from `className`. */
export const AVATAR_IMAGE_SHELL_FILL =
    "relative size-full overflow-hidden outline-[0.5px] -outline-offset-[0.5px] outline-black/16 before:inset-[0.5px]";
