...
export const VideoPlayer = ({
  ...
  const toggleSpeed = () => {
    ...
    setPlaybackRate(Number(nextSpeed));
    if (videoRef.current) {
      videoRef.current.playbackRate = Number(nextSpeed);
    }
  };
          ...
          >
            ...
            >
              <div className="relative h-2 flex-1 rounded-full bg-fg-white/30">
                ...
                {/* Current Progress */}
                <div className="pointer-events-none absolute h-full min-w-2 rounded-full bg-fg-white" style={{ width: `${(currentTime / duration) * 100}%` }} />
