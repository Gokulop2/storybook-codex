...
import { Copy01, DownloadCloud02, Edit04, Link03, RefreshCcw02, Stars02 } from "@opus2-platform/icons";
        ...
        {msg.reactions && msg.reactions.length > 0 && (
          <ul className="flex justify-end gap-1">
            {msg.reactions?.map((reaction) => (
              <li key={reaction.content} className="flex h-6 items-center gap-1 rounded-2xl bg-secondary px-2 py-0.5 ring-1 ring-secondary ring-inset">
                {reaction.content}
