...
import { ArrowDown, ArrowDownRight, ArrowUp, ArrowUpRight, Copy01, Eye, Share01, TrendDown01, TrendUp01, Zap } from "@opus2-platform/icons";
        ...
        <div className="flex items-end justify-between gap-4">
          ...
          >
            ...
            <Area
              ...
              activeDot={false}
            />
            <Area dataKey="b" type="monotone" strokeWidth={0} fill={`url(#gradient-${id})`} fillOpacity={0.2} isAnimationActive={false} activeDot={false} />
          </AreaChart>
        </div>
