  ...
  return (
    <Pagination.Item
      ...
      className={({ isSelected }) =>
        cx(
          "text-quaternary outline-hidden hover:bg-primary_hover hover:text-secondary focus-visible:bg-primary_hover flex size-10 cursor-pointer items-center justify-center p-3 text-sm font-medium transition duration-100 ease-linear focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-offset-2",
  ...
  return (
    <div className={cx("border-secondary border-t px-4 py-3 md:px-6 md:pt-3 md:pb-4", className)}>
      ...
      <nav aria-label="Pagination" className={cx("hidden items-center gap-3 md:flex", align === "center" && "justify-between")}>
        ...
        <span className={cx("text-fg-secondary text-sm font-medium", align === "right" && "order-first mr-auto", align === "left" && "order-last ml-auto")}>
          Page {page} of {total}
        </span>
              ...
              {pages.map((page, index) =>
                page.type === "page" ? (
                  ...
                  <Pagination.Ellipsis key={index}>
                    <ButtonGroupItem className="pointer-events-none size-10 items-center justify-center rounded-none!">&#8230;</ButtonGroupItem>
                  </Pagination.Ellipsis>
                )
              )}
