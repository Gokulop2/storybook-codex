...
const BreadcrumbsWithLine = ({ children, className, ...props }: Omit<BreadcrumbsProps, "type">) => (
    <Breadcrumbs type="text-line" className={className} {...props}>{children}</Breadcrumbs>
);
...
const BreadcrumbsButton = ({ children, className, ...props }: Omit<BreadcrumbsProps, "type">) => (
    <Breadcrumbs type="button" className={className} {...props}>{children}</Breadcrumbs>
);

/** A simple account breadcrumb item that renders an avatar + label link. */
const BreadcrumbSimpleAccountItem = ({ href, avatarSrc, children, isCurrent, className, ...props }: {
    href?: string;
    avatarSrc?: string;
