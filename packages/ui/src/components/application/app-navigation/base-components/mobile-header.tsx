    ...
    <AriaDialogTrigger>
      <header className="border-secondary bg-primary flex h-16 items-center justify-between border-b py-3 pr-2 pl-4 lg:hidden">
        ...
        <AriaButton
          ...
          className="group bg-primary text-fg-secondary outline-hidden hover:bg-primary_hover hover:text-fg-secondary_hover flex items-center justify-center rounded-lg p-2 focus-visible:outline-2 focus-visible:outline-offset-2"
        >
        ...
        {({ state }) => (
          <>
            <AriaButton
              ...
              onPress={() => state.close()}
              className="text-fg-white/70 outline-hidden hover:text-fg-white fixed top-3 right-2 flex cursor-pointer items-center justify-center rounded-lg p-2 hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-offset-2"
            >
