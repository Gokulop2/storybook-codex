    ...
    <>
      <div className="flex gap-0.5">
        ...
        <div className="relative">
          <NavButton current={activeUrl === "/notifications-01"} icon={Bell01} label="Notifications" href="/notifications-01" tooltipPlacement="bottom" />
  ...
  return (
    <>
      ...
      <header className="max-lg:hidden">
        <section className={cx("flex h-16 w-full items-center justify-center bg-primary", (!hideBorder || showSecondaryNav) && "border-b border-secondary")}>
          <div className={cx("flex w-full max-w-container items-center pr-3 pl-4 md:px-8", centered && "gap-8")}>
            <div className={cx("flex items-center", centered ? "flex-1" : "mr-4")}>
              <a aria-label="Go to homepage" href="/" className="rounded-xs outline-hidden focus-visible:outline-2 focus-visible:outline-offset-2">
                <CodexLogo className="h-6" />
              </a>
            </div>
