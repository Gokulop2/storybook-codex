  ...
  return (
    <div className="relative h-180 w-full max-w-180 [--clip-boundary:50%]">
      <div
        ...
        className="peer/light bg-tertiary outline-secondary_alt absolute inset-0 flex items-center justify-center overflow-hidden rounded-2xl outline-1 -outline-offset-1 transition-all duration-200 peer-hover/dark:[--clip-boundary:10%] hover:z-10 hover:[--clip-boundary:90%]"
      >
      ...
      <div
        ...
        className="peer/dark dark-mode bg-tertiary outline-secondary_alt absolute inset-0 flex items-center justify-center overflow-hidden rounded-2xl outline-1 -outline-offset-1 transition-all duration-200 peer-hover/light:[--clip-boundary:90%] hover:z-10 hover:[--clip-boundary:10%]"
      >
        <AriaDatePicker aria-label="Calendar card" value={value} onChange={setValue}>
          <AriaDialog className="bg-primary ring-secondary_alt rounded-2xl shadow-xl ring">
            <div className="flex px-6 py-5">
