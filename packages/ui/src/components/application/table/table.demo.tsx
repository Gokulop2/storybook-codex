            ...
            <Table.Row id={item.name}>
              ...
              <Table.Cell className="pr-0 md:hidden xl:table-cell">
                <div className="flex -space-x-1">
                  <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://picsum.photos/seed/codex-olivia-rhye/128/128" alt="Gokul Krishnan" />
                  <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://picsum.photos/seed/codex-phoenix-baker/128/128" alt="Phoenix Baker" />
                  <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://picsum.photos/seed/codex-lana-steiner/128/128" alt="Lana Steiner" />
                  <Avatar
                    ...
                    alt="Demi Wilkinson"
                  />
                  <Avatar className="ring-bg-primary ring-[1.5px]" size="xs" src="https://picsum.photos/seed/codex-candice-wu/128/128" alt="Candice Wu" />
...
export const TableNoVendorsFound = () => {
  return (
    <TableCard.Root>
      ...
      <div className="flex items-center justify-center overflow-hidden px-8 pt-10 pb-12">
        <EmptyState size="sm">
          ...
          <EmptyState.Content>
            ...
            <EmptyState.Description>Your search “Stripe” did not match any vendors. Please try again or create add a new vendor.</EmptyState.Description>
          </EmptyState.Content>
      ...
      <div className="border-secondary flex items-center justify-between border-t px-6 pt-3 pb-4">
