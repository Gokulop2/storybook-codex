...
import { HelpCircle, SearchLg } from "@opus2-platform/icons";
...
export const CommandInput = ({ placeholder, shortcutKeys, tooltip, className, ...props }: CommandInputProps) => {
  return (
    <AriaGroup
      className={({ isFocusWithin }) => cx("flex items-center gap-x-2 rounded-xl bg-primary p-4", isFocusWithin && "outline-2 outline-hidden", className)}
    >
