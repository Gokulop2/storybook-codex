...
const DocsSection: FC<{ id: string; title: string; children: ReactNode }> = ({ id, title, children }) => (
  <section
    id={id}
    className="group flex w-full scroll-mt-20 flex-col gap-3 my-8"
  >
    ...
    <div className="outline-focus-ring focus-visible:outline-2 focus-visible:outline-offset-2 relative max-w-full md:min-w-[520px] rounded-[20px] flex items-center justify-center py-10 px-6 ring-1 ring-inset ring-secondary bg-primary">
      {children}
    </div>
  </section>
);
...
const ButtonDocsPage: FC = () => {
  ...
  return (
    <main className="relative mx-auto flex w-full min-w-0 flex-1 flex-col lg:flex-row max-w-304">
    <div className="size-full text-tertiary">
      <div className="mb-10">
        <div className="flex items-center gap-2 pb-3">
          <h1 className="max-w-3xl text-xl font-semibold text-primary md:text-display-xs">
            Button components
          </h1>
        </div>

        <p className="typography max-w-3xl text-md whitespace-pre-line">
          Free and open-source React button components built for modern applications and
          websites. These buttons are built using React Aria and styled with Tailwind CSS.
        </p>
      </div>

      <section
        id="button-example"
        className="group flex w-full scroll-mt-20 flex-col gap-3 my-8 not-typography"
      >
        <header className="flex w-full flex-col justify-between gap-3 md:flex-row md:items-center">
            <div className="flex items-center gap-3">
            <h3 className="text-md font-semibold text-primary">
          ...
          <div className="flex items-center justify-between gap-3 md:h-9">
            <div className="flex">
              <DarkModeToggle
                ...
                onToggle={() => setIsPreviewDark((prev) => !prev)}
              />
            ...
            <div className="group flex rounded-lg bg-secondary_alt ring-1 ring-inset ring-secondary order-first gap-0 md:order-last">
              <div className="z-10 flex h-max cursor-pointer items-center justify-center gap-2 whitespace-nowrap transition duration-100 ease-linear text-sm font-semibold py-2 px-3 rounded-lg outline-focus-ring bg-primary_alt text-secondary shadow-xs ring-1 ring-primary ring-inset">
                Preview
              </div>
              <div className="z-10 flex h-max cursor-pointer items-center justify-center gap-2 whitespace-nowrap text-quaternary transition duration-100 ease-linear text-sm font-semibold py-2 px-3 rounded-lg outline-focus-ring">
                Code
              </div>
            </div>
          </div>
        ...
        <div
          className={`outline-focus-ring focus-visible:outline-2 focus-visible:outline-offset-2 relative max-w-full md:min-w-[520px] rounded-[20px] flex gap-3 items-center justify-center py-32 min-h-[320px] ring-1 ring-inset ring-secondary bg-primary ${
      ...
      <section id="installation" className="scroll-mt-20">
        ...
        <div className="mt-6">
          <pre className="group/pre relative w-full max-w-xl overflow-hidden rounded-xl bg-primary shadow-lg ring-1 ring-secondary_alt p-4 font-mono text-sm leading-[24px] font-medium">
      ...
      <h2 id="button-examples" className="scroll-mt-20 text-lg font-semibold text-primary md:text-xl">
