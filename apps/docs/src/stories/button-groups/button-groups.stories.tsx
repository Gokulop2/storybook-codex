    ...
    <div className="bg-primary min-h-screen font-sans" data-codex-docs-button-groups>
      ...
      <main className="relative mx-auto flex w-full max-w-304 min-w-0 flex-1 flex-col">
        <div className="text-tertiary w-full min-w-0">
          ...
          <DocsSection id="leading-icon" title="Leading icon" code={buttonGroupCode.leadingIcon} anchorHeading>
            <div className={previewStack}>
              <ButtonGroup>
          ...
          <DocsSection id="with-dot" title="With dot" code={buttonGroupCode.withDot} anchorHeading>
            <div className={previewStack}>
              <ButtonGroup>
          ...
          <DocsSection id="disabled" title="Disabled" code={buttonGroupCode.disabled} anchorHeading>
            <div className={previewStack}>
              <ButtonGroup isDisabled>
                <ButtonGroupItem id="archive">Archive</ButtonGroupItem>
                <ButtonGroupItem id="edit">Edit</ButtonGroupItem>
          ...
          <DocsSection id="disabled-individual-item" title="Disabled individual item" code={buttonGroupCode.disabledIndividual} anchorHeading>
            <div className={previewStack}>
              <ButtonGroup>
                <ButtonGroupItem id="archive">Archive</ButtonGroupItem>
          ...
          <DocsSection id="selection" title="Selection" code={buttonGroupCode.selection} anchorHeading>
            <div className={previewStack}>
              <ButtonGroup defaultSelectedKeys={["today"]}>
                <ButtonGroupItem id="today">Today</ButtonGroupItem>
                <ButtonGroupItem id="tomorrow">Tomorrow</ButtonGroupItem>
          ...
          <DocsSection id="multiple-selection" title="Multiple selection" code={buttonGroupCode.multipleSelection} anchorHeading>
            <div className={previewStack}>
              <ButtonGroup selectionMode="multiple" defaultSelectedKeys={["today", "week"]}>
                <ButtonGroupItem id="today">Today</ButtonGroupItem>
                <ButtonGroupItem id="tomorrow">Tomorrow</ButtonGroupItem>
