...
const CrumbLink: FC<{ children: ReactNode }> = ({ children }) => (
...
/** Sticky Untitled-style breadcrumb: Base components → Components → current page. */
export const UntitledDocsBreadcrumb: FC<{ currentLabel: string }> = ({ currentLabel }) => (
  <>
